**2022年4月12日更新ProxySU的推荐版本v2.3.1，解决提示域名解析错误的问题。注意：ProxySU官网的最新版已经去掉了很多款工具的搭建模块，如果想按照教程那样搭建SSR等工具，可以下载旧版，本页面也有下载ProxySU-v2.3.0旧版的地址。**
...
当前提供下载的版本为ProxySU-v2.3.1,文件很小,大小为566kb.注意：ProxySU官网的最新版已经去掉了很多款工具的搭建模块，如果想按照教程那样搭建SSR等工具，可以下载旧版。

[国外云盘下载1](https://tr601.free4444.xyz/ProxySU-v2.3.1.zip)  [国外云盘下载2](https://tr201.free4444.xyz/ProxySU-v2.3.1.zip)  
