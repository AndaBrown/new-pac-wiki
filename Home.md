...
最新公告：GoAgent版和GoProxy版无法上YouTube的解决方法：下载完整版，先按照内核升级方法升级浏览器内核至53版本，然后运行ip更新文件，两者缺一不可。注意：因为XP系统只能升级到49内核，而win7及以上系统可以升级到53及以上版本，所以如果你的电脑是xp系统，那么目前你用这两款版本还是没法打开YouTube。鉴于此，有两个建议：一是换电脑系统为win7或以上系统，二是换其它版本，比如PAC版或GOGO翻墙软件等。
