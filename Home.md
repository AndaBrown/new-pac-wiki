...
**2018年3月13日公告：云端更新SSR版、GoProxy Quic版ip，按照使用说明运行ip-1或ip-2文件即可同步到最新的云端配置。由于之前ip-1文件更新地址受阻，如果你运行过ip-1文件出现过“找不到文件”提示，你需要运行ip-1或ip-2文件2～3次，直到不出现“找不到文件”提示，才算更新成功。**
