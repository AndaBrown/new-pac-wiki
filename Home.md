...
**对使用XP系统朋友的建议**
：为了能够使用上更多的翻墙软件，如果经济上不是很困难，建议对XP系统升级到win7或者win10。方法：先看自己电脑的内存，如果内存是1～2G，建议加内存条到4G或者以上（一般内存越大电脑运行更快），将电脑（台式主机或者笔记本）拿到电脑店里，让老板帮你加内存条扩内存，顺便让老板帮你装win7或者win10系统。如果电脑内存在2G以上，网上有很多一键装系统的软件，也可以自己装系统。
