...
**介绍**：Goflyway版、XX-Net、v2ray版、DAZE版、SSR版、Brook版、Lightsocks版、Trojan版、无界版、自由门版，适合windows操作系统，比如：Xp、win7、win8、win10系统。浏览器自带翻译插件和YouTube视频下载脚本，方便且实用。压缩包文件的格式是7z，如果解压出错，用7解压软件来解压（[7z解压软件下载地址](https://sparanoid.com/lab/7z/)）。
