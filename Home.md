...
**2017年10月4日公告：更新GoAgent版、GoProxy版和GoProxy Quic版ip，使用这些版本的朋友，如果近期不好用，可以按照《使用说明（必看）》运行ip更新文件来同步到最新的云端配置。近期我会不定期在云端更新ip，不会每次更新ip都发布公告的。如果更新ip后还是无法使用，再换其它的版本。**
