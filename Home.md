...
视频下载：谷歌浏览器不管是低内核还是高内核，使用GoProxy Quic版、GoProxy ipv6版、GoProxy版都无法下载超过32M文件以上的视频，目前无法修复这个问题。但是，火狐浏览器的GoProxy Quic版、GoProxy ipv6版、GoProxy版可以下载超过32M的文件。所以，想下载视频的，可以用火狐浏览器的对应版本或者谷歌浏览器的其它版本来下载。
