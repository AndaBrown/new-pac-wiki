...
### 最新公告：最近干扰有点大，使用GoAgent版和GoProxy版时出现YouTube首页无法打开的问题，但有的地区可以正常访问YouTube，所以这跟不同的地区还有关系。现已在云端进行了初步修改，请按照使用说明运行ip更新文件来同步到最新配置，欢迎反馈。别太急，肯定有办法可以解决的。 ————2017年6月14日凌晨。
