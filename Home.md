...
我想说的话：近期GFW防火墙对国际出口线路进行了干扰，很多国内翻墙工具都有不同程度的速度降低以及不稳定的表现，当然不同的网络环境表现会有所不同，电信干扰最严重，尤其是晚上。我分享的GoAgent和GoProxy版用的是谷歌ip，考虑到不同的地区使用效果不同，所以建议有条件的朋友，时不时告诉我一下目前版本的good ip的个数，这样更方便我及时更新ip，以应对GFW的封锁，从而提高软件的体验度，造福更多的人。可以发邮件告诉我，最好告诉我地区、宽带类型以及good ip的个数。在打开网页时good ip的个数可以从黑框插件里面的内容里找到（多打开几个网站才能全部加载所有的ip，当good ip个数没有增长时，个数才是准确的）。
