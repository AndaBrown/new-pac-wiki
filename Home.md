...
**2020年2月28日公告：最新的谷歌浏览器全新版或Goflyway单独版的ip2更新地址才用了新的技术和加密协议，ip2与ip1不同，会根据国内不同的地区以及宽带类型来分配不同的ip，提高稳定性和速度，使用Goflyway的朋友可以进行尝试。测试结果可以给我反馈，发聩的数据越多，以后越能更好的进行优化。反馈内容：宽带类型、省份城市、速度（白天和晚上）。反馈邮箱：kebi2014@gmail.com**
