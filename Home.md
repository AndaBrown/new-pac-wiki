...
**提醒**：最新的AllNew全新版大多数翻墙工具的ip-1和ip-2的配置信息都会不一样，即使现在一样，以后也会逐步让它不一样，尽可能让所有地区的人都能用，所以如果其中一个ip更新不好用，可以尝试另外一个。另外，解压路径不要含有中文或空格的目录路径（比如Program Files文件夹就不行），不然会提示找不到路径。
