...
**2018年3月13日公告：云端更新SSR版、GoProxy Quic版ip，按照使用说明运行ip-1或ip-2文件即可同步到最新的云端配置。由于之前ip-1文件更新地址受阻，如果你运行过ip-1文件出现过“找不到文件”提示，你需要运行ip更新文件2～-3次，直到不出现“找不到文件”提示才算更新成功。另外，如果你将GoProxy Quic版更新到最新的ip，但仍然用不了，浏览器提示"error": "read udp: closing session in order to recreate it with a new version"，说明这种翻墙方式已被封锁，请更换其它类型的软件。**
