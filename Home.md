...
**介绍**：Goflyway、XX-Net、v2ray、DAZE、SSR、Brook、Lightsocks、Trojan、Astar、SkyZip、无界、自由门，适合windows操作系统，比如：Xp、win7、win8、win10系统。浏览器自带翻译插件和YouTube视频下载脚本，方便且实用。压缩包文件的格式是7z，如果解压出错，用7解压软件来解压（[7z解压软件下载地址](https://sparanoid.com/lab/7z/)）。
...
**选择指南**：Goflyway、XX-Net、v2ray、DAZE、SSR、Brook、Lightsocks、Trojan、Astar、SkyZip、无界、自由门可以按照顺序依次尝试。由于国内网络环境不同、地区不同，封锁强度会不同，所以使用效果会有差别，有的地区几乎所有的软件都能使用，有的只能用几款，因此具体哪款软件适合你的网络环境，需要你自己来尝试。xp系统只能用低内核版。还有[直翻通道](https://github.com/Alvin9999/new-pac/wiki/%E7%9B%B4%E7%BF%BB%E9%80%9A%E9%81%93)可供选择，电脑、手机、平板都能使用。如果想自己搭建翻墙服务器，可以学习自建服务器教程（图文教程，步骤详细，适合新手）。
...
**提醒：解压路径不要含有中文或空格的目录路径（比如Program Files文件夹就不行），不然会提示找不到文件。win10系统的防火墙可能会起网络阻碍作用，如果多款工具无法使用，可以把防火墙关闭再试试看。**

**由于分享的工具有点多，为了能够及时修复不能用的，可以多多反馈使用效果，包括速度大幅度降低了、不能使用了等。比如：goflyway ip2之前能用，现在不能用了；daze ip1之前速度特别快，现在速度太慢了，等等。反馈内容最好提一下用的什么宽带类型，比如电信、联通、移动、教育网。区域可以提省份或城市。**
...
[火狐翻墙浏览器](https://github.com/Alvin9999/new-pac/wiki/%E7%81%AB%E7%8B%90%E7%BF%BB%E5%A2%99%E6%B5%8F%E8%A7%88%E5%99%A8)（2020年3月12日更新AllNew全新版，v2ray支持xp系统）
