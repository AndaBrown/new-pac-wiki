...
**2018年3月13日～14日：云端更新SSR版、GoProxy、Quic版、GoProxy ipv6版和GoAgent ipv6版google ipv6 ip，按照使用说明运行ip更新文件即可同步到最新的云端配置。**
...
**关于Quic版：如果你将GoProxy Quic版更新到最新的ip，但仍然用不了，浏览器提示"error": "read udp: closing session in order to recreate it with a new version"，请更换其它类型的软件。**
