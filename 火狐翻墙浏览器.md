...
**2019年11月15日云端更新v2ray版配置信息，提升速度，按照使用说明运行ip更新文件即可同步。**
...
压缩包名称：Firefox52_Lightsocks_2019.10.28.7z，文件大小72.1M。

**使用方法：下载后解压，按使用说明（必看）操作即可。使用前请先按照使用说明文档运行ip更新文件，将Lightsocks配置信息更新到最新的云端配置。以后不好用的时候记得更新一下ip。**

**下载地址：**

[国外云盘下载](http://108.61.224.82/1028/Firefox52_Lightsocks_2019.10.28.7z) 
