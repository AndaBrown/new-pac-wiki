...
4.亲测shadowrocket很好用，里面功能很全。打开shadowrocket，填上配置文件地址后就可以添加节点信息，类型选择showdowsocksR即可配置SSR节点信息。
...
**第一步(可选）**：打开配置选项，按照图例把这个**白名单+去广告配置文件地址**填上去：https://raw.githubusercontent.com/h2y/Shadowrocket-ADBlock-Rules/master/sr_top500_whitelist_ad.conf
