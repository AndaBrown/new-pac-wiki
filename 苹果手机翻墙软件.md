...
**Fair VPN当前版本1.0.7，支持ssr、ss、trojan、v2ray，[github项目地址](https://github.com/fqcdn/fq/releases/tag/v1.0.0)。**
...
需要提醒的是，从第三方获取免费节点后，由于软件目前没有一键检测节点可用性的功能，所以节点是否可用，需要自己来尝试一下哦。

![](https://cdn.jsdelivr.net/gh/Alvin9999/pac2/fairvpn/fairvpn5.jpg)

安装方法2：

用中国以外地区苹果帐号登录应用商店，然后安装Fair VPN](https://apps.apple.com/us/app/id1533873488)，地址：https://apps.apple.com/us/app/id1533873488
