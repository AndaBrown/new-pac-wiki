...
为保证每个用户都能获得一定的带宽资源，单个用户限速150kb/s。以下账号SSR客户端和SS客户端都能使用。禁止使用账号进行BT下载、发送垃圾邮件。如果使用ipv6账号，需要将自己的电脑开启ipv6网络，ipv6账号是为那些有ipv6这方面需求的用户提供的，一般的人用普通的ip即可。

**2018年4月11日：修复服务器1，调整单个用户速度至150kb/s。**
