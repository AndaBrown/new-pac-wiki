...
**北京时间2020年8月31日8点40分更新洛杉矶1帐号。rc4加密方式只有SSR客户端有，所以要用SSR客户端。禁止使用账号进行BT下载、滥发垃圾邮件、DDOS攻击！这些行为会导致服务器被投诉而被封！如果不能看到最新的账号信息，把浏览器缓存清理一下。**

备用网址：https://tr1.freeair888.club/ss免费账号 

***

**以下SSR账号密码都有一个空格。为保证每个人都能获得一定的带宽资源，帐号进行了单线程限速。**
