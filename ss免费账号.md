...
**8月10日更新SS版浏览器配置文件。下载过版本的用户只需要按照说明运行一下ip更新文件即可同步到云端最新配置。**
...
服务器4：47.88.153.90 端口：666  密码：ntdtv.com  加密方式: AES-256-CFB  SSR协议(**必填**）： 协议：auth_sha1_v4   混淆：tls1.2_ticket_auth （gemp网友分享）
