...
**北京时间2020年9月5日8点46分更新日本2帐号。禁止使用账号进行BT下载、滥发垃圾邮件、DDOS攻击！这些行为会导致服务器被投诉而被封！如果不能看到最新的账号信息，把浏览器缓存清理一下。**

备用网址：https://tr1.freeair888.club/ss免费账号 

***

**以下SSR账号密码都有一个空格。为了让每个人都能获得一定的带宽资源，帐号进行了单线程限速。RC4加密方式为SSR客户端专有，aes-256-gcm加密方式为SSR客户端专有。**
