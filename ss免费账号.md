...
[Vultr](http://www.vultr.com/?ref=6999340) **（知名服务器供应商；全球15个服务器位置可选，KVM框架，最低2.5美元/月。服务器地址优先选择：美国西海岸等靠近大陆的服务器。 温馨提醒：同样的服务器位置，不同的宽带类型和地区所搭建的账号的翻墙速度会不同，所以最好亲测一下。**

[Vultr](http://www.vultr.com/?ref=6999340) 实际上是**折算成小时来计费**的，比如服务器是5美元1个月，那么每小时收费为5/30/24=0.0069美元 会自动从账号中扣费，只要保证账号有钱即可。如果你部署的服务器实测后不理想，你可以把它删掉（destroy），重新换个地区的服务器来部署，很方便。
...
2017年11月10日对自建ss/ssr服务器教程细节方面进行补充，方便新手。

2017年8月30日更新：[Vultr](http://www.vultr.com/?ref=6999340) 支持支付宝（Alipay）付款。
...
为保证每位用户都能够分配到一定的带宽资源，以下账号会进行单线程限速处理。为预防SSR账号不会因为使用人数猛增而导致账号没法使用，每个SSR账号会设置同时在线最大设备数。如果自己搭建服务器就没有这个限制。

**2017年11月11日：又有人滥用服务器下载有版权的电影，造成服务器被投诉。取消分享一段时间，建议自己搭建SSR账号。**
