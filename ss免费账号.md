...
**北京时间2020年10月20日22点30分新增韩国节点，16点03分更新洛杉矶1、洛杉矶2、日本1、日本2节点端口，7点50分新增新加坡节点。以下节点密码都有一个空格。为了让每个人都能获得一定的带宽资源，节点进行了限速。禁止使用节点进行BT下载、滥发垃圾邮件、DDOS攻击！如果不能看到最新的节点信息，把浏览器缓存清理一下。**
