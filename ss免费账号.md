...
**2020年2月13日更新。经过测试发现aes-256-cfb和rc4-md5很容易就被封掉端口，所以在目前这种封锁强度下主要还是用rc4。如果你的客户端没有rc4加密方式，可以在下面下载新的客户端或者用SSR客户端。如果你不能看到最新的账号信息，把浏览器缓存清理了。**
...
**洛杉矶1**：162.245.239.74       端口：456          密码： dongtaiwang.com
