...
[Vultr](http://www.vultr.com/?ref=7048874) **（知名服务器供应商；全球15个服务器位置可选，KVM框架，最低2.5美元/月。服务器地址优先选择：洛杉矶（Los Angeles）、日本东京（Tokyo）、硅谷（Silicon Valley）、新加坡（Singapore）） 温馨提醒：同样的服务器位置，不同的宽带类型和地区所搭建的账号的翻墙速度会不同，所以最好亲测一下。**
