...
**北京时间2020年10月28日7点07分更新节点。为了让每个人都能获得一定的带宽资源，节点进行了限速。禁止使用节点进行BT下载、滥发垃圾邮件、DDOS攻击！如果不能看到最新的节点信息，把浏览器缓存清理一下。**
...
**近期封锁特别严重，会持续更新。有条件的可以按照教程自己搭建节点，这样要稳定一些。在目前这个网络环境免费节点流量大了之后容易被封。**
