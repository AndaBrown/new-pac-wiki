...
近期高内核版里面的内核升级器失效了，但不影响浏览器的正常使用，然而每次启动时都会遇到更新提示，可以通过这个方法来关闭每次的更新提示。打开GreenChrome.ini文件，在文件内容的最后面将检查更新后面的数字1改为0，然后保存即可。

![](https://raw.githubusercontent.com/Alvin9999/pac2/master/内核1.png)

![](https://raw.githubusercontent.com/Alvin9999/pac2/master/内核2.png)
