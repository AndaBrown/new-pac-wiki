...
注册并邮件激活账号后，需要首次充值最低5美元，方可获得20美元的优惠奖励。方式是信用卡或者采用全球付的paypal，如果没有信用卡或者信用卡支付失败，可以用paypal，因为paypal可以支持银联卡，不仅是信用卡。注册paypal很简单（网站：paypal.com），这里就不弄教程了，百度或者google一下就有了。如图：
