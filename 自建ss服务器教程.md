...
购买vps服务器时，服务器地址优先选择：日本、洛杉矶、硅谷、新加坡。**选择CentOS 6.X64位的系统（推荐。系统版本不要选的太高，不然装不上！）**。完成购买后，找到系统的密码记下来，部署服务器时需要用到。如图：
...
vultr实际上是折算成小时来计费的，比如服务器是5美元1个月，那么每小时收费为5/30/24=0.0069美元 会自动从账号中扣费，只要保证账号有钱即可。所以如果你部署的服务器实测后不理想，你可以把它删掉，重新换个地区的服务器来部署，不影响扣费，很方便。
