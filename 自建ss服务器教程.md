...
如果你是苹果电脑操作系统，更简单，无需下载PuTTY，系统可以直接连接VPS。打开**终端**（Terminal），输入ssh root@ip  其中“ip”替换成你VPS的ip, 按回车键，然后复制粘贴密码，按回车键即可登录。粘贴密码时有可能不显示密码，但不影响。 参考：http://www.cnblogs.com/ghj1976/archive/2013/04/19/3030159.html
