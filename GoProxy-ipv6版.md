...
压缩包名称Chrome53_gop_ipv6_v2018.4.4.7z ，文件大小155M。主程序为谷歌浏览器36内核，压缩包里的ChromeUpdate文件夹有两个内核离线包(Xp系统49.0.2623.112内核和win7及以上系统53内核），共计86M。

**使用方法：下载后解压，按文件夹里面的《使用说明（必看）》操作。当电脑重启后，翻墙前需要再次运行开启ipv6脚本。**

**下载地址：**

[国外云盘1下载](http://45.32.141.248:8000/f/dcb26d0077/) 密码：12345678
