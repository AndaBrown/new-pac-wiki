**2017年6月14日云端更新设置，解决YouTube首页无法打开的问题，旧版用户按照使用说明运行ip更新文件即可同步，之后必须升级浏览器内核为53版本才能生效。注意：因为XP系统只能升级到49内核，而win7及以上系统可以升级到53及以上版本，所以如果你的电脑是xp系统，那么目前你用这两款版本还是没法打开YouTube。鉴于此，有两个建议：一是换电脑系统为win7或以上系统，二是换其它版本，比如PAC版或GOGO翻墙软件等。**
